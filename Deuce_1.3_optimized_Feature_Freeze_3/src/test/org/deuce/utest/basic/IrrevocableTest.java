...
public class IrrevocableTest extends TestCase{
	...
	public static class MockContext implements Context{
		...
		@Override
		public Object onReadAccess(Object obj, Object value, long field, int advice) {return null;}

		@Override
		public boolean onReadAccess(Object obj, boolean value, long field, int advice) {return false;}

		@Override
		public byte onReadAccess(Object obj, byte value, long field, int advice) {return 0;}

		@Override
		public char onReadAccess(Object obj, char value, long field, int advice) {return 0;}

		@Override
		public short onReadAccess(Object obj, short value, long field, int advice) {return 0;}

		@Override
		public int onReadAccess(Object obj, int value, long field, int advice) {return 0;}

		@Override
		public long onReadAccess(Object obj, long value, long field, int advice) {return 0;}

		@Override
		public float onReadAccess(Object obj, float value, long field, int advice) {return 0;}

		@Override
		public double onReadAccess(Object obj, double value, long field, int advice) {return 0;}
