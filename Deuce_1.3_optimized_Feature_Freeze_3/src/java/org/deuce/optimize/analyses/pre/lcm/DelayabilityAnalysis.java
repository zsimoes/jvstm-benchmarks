 ...
 * 
 * an expression e is "delayable" in u, if all paths leading to u have seen
 * the earliest placement of e but not a subsequent use
 * 
 *  delayable = downsafe + earliest, or all predecessors are delyable and don't use e.
 */
