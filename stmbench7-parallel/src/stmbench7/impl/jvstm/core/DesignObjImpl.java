...
public class DesignObjImpl implements DesignObj {
    ...
    private final int finalBuildDate;
	...
	return this.getClass().getName() + ": id=" + id + ", type=" + type + ", buildDate=" + buildDate.get();
    }
    ...
    @Override
    public int getFinalBuildDate() {
	return finalBuildDate;
    }
