...
public class Parameters {
	 ...
	 * values describe the data structure only at its initial state, before
	 * the first structure modification operation completes with success.
	 */
	...
	/**
	 * Constants used in various operations (values taken from the original
	 * OO7 source code).
	 */
