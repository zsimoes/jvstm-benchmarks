...
/**
 * Creates factories suitable for a given synchonization method. Default
 * implementations are provided for coarse-grained and medium-grained locking,
 * as well as for single-threaded executions (i.e., without any thread
 * synchronization).
 */
@NonAtomic
